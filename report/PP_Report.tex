...
\section{Camera}
\label{cam}
\IEEEPARstart{I}{n} this section we describe how the right vector, the up vector and the
...
\IEEEPARstart{O}{n} Figure~\ref{fig:dof}, we can observe the depth of field effect. The idea
